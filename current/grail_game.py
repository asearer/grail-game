...
while grail == False:
    ...
    print("                                    ")
    print("Where do you want to go ? (Castle, The Old Hags Hut, The Wild Forest or The fortress of doom )")
    print(" Castle   The Old Hags Hut   The Wild Forest   Fortress of Doom")
    Choice = input()
    Choice = Choice.lower()
...
###comes to crossroad make choice
